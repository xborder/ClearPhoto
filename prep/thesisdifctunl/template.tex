...
\title{ClearPhoto - Fotografia Aumentada}

% Autor
\author[m]{Hélder Filipe Gouveia Gregório} 
\authordegree{Licenciatura em Engenharia Informática}
...
\adviser[m]{Nuno Manuel Robalo Correia}{Prof.\ Catedrático}{Universidade Nova de Lisboa}
...
\chapterfile{concepts}
\chapterfile{related_work}
\chapterfile{work_plan}
